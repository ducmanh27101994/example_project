...
@section('content')
    <form method="post" action="{{route('admin.submit.editBlog',['id' => $editBlog->id])}}"
                                                ...
                                                <div class="block_sp">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="news_headlines" type="text"
                                                               ...
                                                               value="{{!empty(old('news_headlines')) ? old('news_headlines') : $editBlog->news_headlines}}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="describe" rows="2"
                                                                  ...
                                                                  style="height:80px;width:100%;">{{!empty(old('news_headlines')) ? old('news_headlines') : $editBlog->describe}}</textarea>

                                                    </div>
                                                    <div class="form-group">
                                                        <label class="next-label">Chi tiết</label>
                                                        <textarea name="detail" id="detail" cols="50"
                                                                  rows="30">{{!empty(old('news_headlines')) ? old('news_headlines') : $editBlog->detail}}</textarea>
                                                ...
                                                <div class="block_sp">
                                                    ...
                                                    <div class="center">
                                                        <img height="100" style="max-width:600px"
                                                             @if(!empty($editBlog->representative_image))
                                        ...
                                        <table class="admintable">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                        <span
                                                            class="page-title-seo">{{$editBlog->page_title_tag}}</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input name="page_title_tag" type="text"
                                                           ...
                                                           style="width:460px;"
                                                           value="{{!empty(old('page_title_tag')) ? old('page_title_tag') : $editBlog->page_title_tag}}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                                <textarea name="keyword_tags" rows="5" cols="70"
                                                                          ...
                                                                          style="height:80px;">{{!empty(old('keyword_tags')) ? old('keyword_tags') : $editBlog->keyword_tags}}</textarea>
                                                    <a href="#" class="tooltip">
                                                        <img src="{{ asset('images/help-icon.png') }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                                <textarea name="description_card" rows="5" cols="70"
                                                                          ...
                                                                          style="height:80px;">{{!empty(old('description_card')) ? old('description_card') : $editBlog->description_card}}</textarea>
                                                    <a href="#" class="tooltip">
                                                        <img src="{{ asset('images/help-icon.png') }}">
