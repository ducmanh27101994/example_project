                    ...
                    <div class="tab-right-box">
                                                ...
                                                <div class="rf-note">
                                                    ...
                                                    <ul>
                                                        <li>Để hưởng ưu đ&atilde;i, bạn cần đ&aacute;p ứng đủ
                                                            c&aacute;c điều kiện của chương tr&igrave;nh.</li>
                                        ...
                                        <div class="properties select-group mb-0">
                                            ...
                                            <div class="box-select last">
                                                <div class="form-label-group has-icon">
                                                    <select
                                                        class="select2-search select2-label-placeholder select2-empty"
                                                        id="storeList" placeholder data-store-selected="false">
                                                        <option value selected></option>
                                                    </select>
                                                    <div class="icon">
                                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    ...
                                                    <label class="select-label required">Showroom</label>
                                                </div>
                                                <div class="col">
                                                    <div class="invalid-feedback text-left"
                                                        id="storeListInvalidMessage"></div>
                                                    <span class="d-none">Vui l&ograve;ng chọn Showroom.</span>
                                                </div>
                                            </div>
                        ...
                        <div class="payment-informations-step d-none" id="payment-informations"
                            ...
                            <div class="block-deposit-info  bg-white">
                                ...
                                <div class="voucher block-vouOrder">
                                    <h3 class="group-title font-18">M&atilde; ưu đ&atilde;i</h3>
                                    <div class="voucher-input-group">
                                        <form
                                            action="/on/demandware.store/Sites-app_vinfast_vn-Site/vi_VN/CartBike-AddCoupon"
                                            class="promo-code-form" method="GET" name="promo-code-form">
                                            <input type="hidden" name="eScooterEnableCouponVerify" value="true" />
                                            <div class="promo-code-field voucher-input-container">
                                                <div id="voucherInput" class="tab-pane active p-0 voucher-input ">
                                                    <input type="text"
                                                        class="form-control coupon-code-field cart-input-field couponCode"
                                                        name="couponCode" placeholder="Nhập m&atilde; E-voucher..." />
                                                    <button type="submit">
                                                        <span>&Aacute;p dụng</span>
                                                    </button>
                                                </div>
                                                <p class="error-text d-none">M&atilde; của Qu&yacute; kh&aacute;ch
                                                    chưa đ&uacute;ng. Vui l&ograve;ng kiểm tra v&agrave; nhập lại.
                                                </p>
                                            </div>
                                            <input class="crfToken" type="hidden" name="csrf_token"
                                                value="OaU3W7GrAa3GB4pkVyzh60hNIPMH6FCI5Ize3OGtf-MWSmb_pAxnTRo4vJjlXohUP2s1dQu0-NM-Is1Ryfrzn4liT-CeKtsV8GHcTGly-d5aW0rLyJAWuFmCZINPe21X06j8BBcS05Ysu95gtFI_i5519ZDtRizQ3gb4JGHVp3Wo62wLbcY=" />
                                            <input class="productId" name="productId" type="hidden"
                                                value="VF-ZFG-ESNA5LHH-REQ" />
                                        </form>
                                        <div class="coupons-and-promos mt-2 voucher-detail">
                                        </div>
                                    </div>
                                </div>
                                <form
                                    action="https://shop.vinfastauto.com/on/demandware.store/Sites-app_vinfast_vn-Site/vi_VN/CheckoutServices-Confirm"
                                    method="POST" name="payment-form" id="paymentForm" onsubmit="return false;">
                                    <input type="hidden" name="campaign" value>
                                    <input type="hidden" name="is-vtm" value="false">
                                    <input type="hidden" name="loanApplicationID" value="null">
                                    <input type="hidden" name="csrf_token"
                                        value="OaU3W7GrAa3GB4pkVyzh60hNIPMH6FCI5Ize3OGtf-MWSmb_pAxnTRo4vJjlXohUP2s1dQu0-NM-Is1Ryfrzn4liT-CeKtsV8GHcTGly-d5aW0rLyJAWuFmCZINPe21X06j8BBcS05Ysu95gtFI_i5519ZDtRizQ3gb4JGHVp3Wo62wLbcY=" />
                                    <div class="m-0">
                                        <div>
                                            <h3 class="group-title mt-5">H&igrave;nh thức thanh to&aacute;n</h3>
                                        </div>

                                        <ul class="nav nav-tabs nav-pills flex-nowrap nav-tab-payment nav-tab-payment-bike flex-column"
                                            aria-orientation="vertical" id="payment-method-bike">
                                            <li class="nav-item ">
                                                <a class="nav-link" data-toggle="tab" href="#tabPayMentTM">
                                                    <input type="radio" id="rad-payment-tm" value="Cash"
                                                        name="paymentMethod" class="custom-input-box radio-circle">
                                            ...
                                            <li class="nav-item ">
                                                <a class="nav-link" data-toggle="tab" href="#tabPayMentAtmCard">
                                                    <input type="radio" id="rad-payment-atm" value="AtmCard"
                                                        name="paymentMethod" class="custom-input-box radio-circle">
                                                    <label for="rad-payment-atm">Thẻ ATM nội địa / Internet
                                                        Banking</label>
                                                </a>
                                                <div class="tab-content mt-10">
                                                    <div id="tabPayMentAtmCard"
                                                        class="tab-payment-gate col-12 tab-pane p-0 ">
                                                        <p class="guide-msg">Qu&yacute; kh&aacute;ch vui l&ograve;ng
                                                            chọn cổng thanh to&aacute;n</p>
                                                        <div class="bg-white row m-0 text-left gate-container">
                                                            <div class="gate-item">
                                                                <input type="radio" id="paymentGatewayAtmCardOnepay"
                                                                    value="OnePay" name="paymentGateway"
                                                                    class="custom-input-box radio-circle col-12">
                                                                <label for="paymentGatewayAtmCardOnepay">
                                                                    <img src="https://shop.vinfastauto.com/on/demandware.static/-/Sites-app_vinfast_vn-Library/default/dw5d4c0e6e/images/XMD/logo/one-pay.png"
                                                                        alt="OnePay" />
                                                                    Cổng OnePay
                                                                </label>
                                                            </div>
                                                            <div class="gate-item">
                                                                <input type="radio" id="paymentGatewayAtmCardPayoo"
                                                                    value="Payoo" name="paymentGateway"
                                                                    class="custom-input-box radio-circle col-12">
                                                                <label for="paymentGatewayAtmCardPayoo">
                                                                    <img src="https://shop.vinfastauto.com/on/demandware.static/-/Sites-app_vinfast_vn-Library/default/dw415c4c8f/images/XMD/logo/payoo-logo.png"
                                                                        alt="Payoo" />
                                                                    Cổng Payoo
                                                                </label>
                                                            </div>
                                            ...
                                            <li class="nav-item ">
                                                <a class="nav-link" data-toggle="tab" href="#tabPaymentCKNH">
                                                    <input type="radio" id="rad-payment-CKNH" value="BankTransfer"
                                                        name="paymentMethod" class="custom-input-box radio-circle">
                                                    <label for="rad-payment-CKNH">Chuyển khoản ng&acirc;n
                                                        h&agrave;ng</label>
                                                </a>
                                                <div class="tab-content">
                                                    <input type="hidden" name="pcAction" class="hidden"
                                                        value="bikeOrder" />
                                                </div>
                                            </li>
                                            <div class="line"></div>
                                            <li class="nav-item ">
                                                <a class="nav-link " href="#resultPayment">
                                                    <input type="radio" id="rad-payment-banktranfer"
                                                        value="INSTALLMENT_VIA_CREDIT_CARD" name="paymentMethod"
                                                        class="custom-input-box radio-circle">
                                                    <label for="rad-payment-banktranfer">Trả g&oacute;p qua thẻ
                                                        t&iacute;n dụng</label>
                                                </a>
                                                <div class="tab-content">
                                                    <div id="resultPayment">
                                                        <div class="no-payment-chosen d-none">
                                                            <p>Quý khách chưa lựa chọn gói trả góp.</p>
                                                            <a data-toggle="modal" data-target="#popupPayment"
                                                                class="nav-link " data-toggle="tab"
                                                                href="#tabPaymentInstallment">
                                                                Xem chi tiết
                                                            </a>
                                                        </div>
                                                        <div class="have-payment-chosen d-none">
                                                            <div class="gateway-container col-12 p-0">
                                                                <div class="gateway-item-form clicked"
                                                                    data-href="/on/demandware.store/Sites-app_vinfast_vn-Site/vi_VN/OnePay-Installments">
                                                                    <input type="radio"
                                                                        id="paymenFormtGatewayInstallmentOnepay"
                                                                        data-href="/on/demandware.store/Sites-app_vinfast_vn-Site/vi_VN/OnePay-Installments"
                                                                        value="OnePay" name="paymentGatewayInstallment"
                                                                        class="custom-input-box radio-circle col-12"
                                                                        checked>
                                                                    <label for="paymentGatewayInstallmentOnepay">Cổng
                                                                        thanh to&aacute;n OnePay</label>
                                                                </div>
                                                                <div class="gateway-item-form"
                                                                    data-href="/on/demandware.store/Sites-app_vinfast_vn-Site/vi_VN/Payoo-Installments">
                                                                    <input type="radio"
                                                                        id="paymentFormGatewayInstallmentPayoo"
                                                                        data-href="/on/demandware.store/Sites-app_vinfast_vn-Site/vi_VN/Payoo-Installments"
                                                                        value="Payoo" name="paymentGatewayInstallment"
                                                                        class="custom-input-box radio-circle col-12">
                                                                    <label for="paymentGatewayInstallmentPayoo">Cổng
                                                                        thanh to&aacute;n Payoo</label>
                                                                </div>
                                                            </div>
                                                            <div id="formPaymentInstallment"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="popup-payment">
                                                    <div class="modal fade" id="popupPayment">
                                                        <div class="modal-dialog popup-container">
                                                            <svg class="check-icon" width="28" height="28"
                                                                viewBox="0 0 28 28" fill="none"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                                    d="M0.666992 13.9998C0.666992 6.63604 6.63653 0.666504 14.0003 0.666504C21.3641 0.666504 27.3337 6.63604 27.3337 13.9998C27.3337 21.3636 21.3641 27.3332 14.0003 27.3332C6.63653 27.3332 0.666992 21.3636 0.666992 13.9998ZM18.4938 9.50638C18.9672 9.97974 18.9672 10.7472 18.4938 11.2206L15.7145 13.9998L18.4938 16.7791C18.9672 17.2525 18.9672 18.0199 18.4938 18.4933C18.0204 18.9667 17.253 18.9667 16.7796 18.4933L14.0003 15.714L11.2211 18.4933C10.7477 18.9667 9.98023 18.9667 9.50686 18.4933C9.0335 18.0199 9.0335 17.2525 9.50686 16.7791L12.2861 13.9998L9.50686 11.2206C9.0335 10.7472 9.0335 9.97974 9.50686 9.50638C9.98023 9.03301 10.7477 9.03301 11.2211 9.50638L14.0003 12.2856L16.7796 9.50638C17.253 9.03301 18.0204 9.03301 18.4938 9.50638Z"
                                                                    fill="white" />
                                                            </svg>
                                                            <div class="modal-content">
                                                                <div class="close-popup-icon">
                                                                    <svg class="close-popup-mobile" width="39"
                                                                        height="8" viewBox="0 0 39 8" fill="none"
                                                                        xmlns="http://www.w3.org/2000/svg">
                                                                        <path d="M1.5 1L19.5 7L37.5 1" stroke="#3C3C3C"
                                                                            stroke-width="1.6" stroke-linecap="round"
                                                                            stroke-linejoin="round" />
                                                                    </svg>
                                                                </div>
                                                                <div class="mt-10 tab-content popup-content">
                                                                    <div class="bg-white row m-0 pl-lg-4 text-left">
                                                                        <p class="credit-title">TRẢ GÓP QUA THẺ TÍN
                                                                            DỤNG</p>
                                                                        <div class="gateway-container col-12 p-0">
                                                                            <div class="gateway-item clicked">
                                                                                <input type="radio"
                                                                                    id="paymentGatewayInstallmentOnepay"
                                                                                    data-href="/on/demandware.store/Sites-app_vinfast_vn-Site/vi_VN/OnePay-Installments"
                                                                                    value="OnePay"
                                                                                    name="paymentGatewayInstallment"
                                                                                    class="custom-input-box radio-circle col-12"
                                                                                    checked>
                                                                                <label
                                                                                    for="paymentGatewayInstallmentOnepay">Cổng
                                                                                    thanh to&aacute;n OnePay</label>
                                                                            </div>
                                                                            <div class="gateway-item">
                                                                                <input type="radio"
                                                                                    id="paymentGatewayInstallmentPayoo"
                                                                                    data-href="/on/demandware.store/Sites-app_vinfast_vn-Site/vi_VN/Payoo-Installments"
                                                                                    value="Payoo"
                                                                                    name="paymentGatewayInstallment"
                                                                                    class="custom-input-box radio-circle col-12">
                                                                                <label
                                                                                    for="paymentGatewayInstallmentPayoo">Cổng
                                                                                    thanh to&aacute;n Payoo</label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-12 p-0 mt-10 mb-10">
                                                                            <div text-choose="chọn"
                                                                                text-chosen="đã chọn"
                                                                                id="tabPaymentInstallment"
                                                                                class="tab-pane p-0 ">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                            ...
                                            <li class="nav-item detail " style="display: none !important;">
                                                <a class="nav-link pb-0" data-toggle="tab"
                                                    data-target="#easyCreditModal">
                                                    <input type="radio" id="rad-payment-EC"
                                                        value="INSTALLMENT_VIA_EASY_CREDIT" name="paymentMethod"
                                                        class="custom-input-box radio-circle" disabled>
                                                    <label for="rad-payment-EC">Trả g&oacute;p qua
                                                        EVNFinance</label>
                                                </a>
                                                <a class="link-detail"
                                                    href="https://shop.vinfastauto.com/on/demandware.static/-/Sites-app_vinfast_vn-Library/vi_VN/dwd40b700b/evn/Chuong Trinh Tra Gop XMD VINFAST_03-2022.pdf"
                                ...
                                <div class="order-bill">
                                    <ul class="order-bill-items">
                                        <li
                                            class="d-flex justify-content-between align-items-center leasingService-item">
                                            <span class>Thu&ecirc; pin</span>
                                            <span class="payment-sum">350.000VNĐ </span>
                                        </li>
                                        <li class="note-bill">Ph&iacute; thu&ecirc; pin Qu&yacute; kh&aacute;ch vui
                                            l&ograve;ng thanh to&aacute;n khi đến Showroom l&agrave;m thủ tục hợp
                                            đồng v&agrave; nhận xe.</li>
                                        <li class="border-price"></li>
                                        <li class="d-flex justify-content-between align-items-center">
                                            <span>Gi&aacute; xe</span>
                                            <span class="payment-sum finance-item--price-before-savings"><span
...
<input type="hidden" id="price_product" value="">
