            ...
            <div class="widget-body">
                <div style="width: 100%; display: block; margin: 0px;" id="parentHorizontalTab" class="divvalidate" novalidate="novalidate">
                    <ul class="resp-tabs-list hor_1">
                        <li class="resp-tab-item hor_1 resp-tab-active" aria-controls="hor_1_tab_item-0" role="tab" style="background-color: white; border-color: rgb(193, 193, 193);">Mã xác minh Google Master Tool</li>

                    </ul>
                    <div class="resp-tabs-container hor_1" style="border-color: rgb(193, 193, 193);">
                        <h2 class="resp-accordion hor_1 resp-tab-active" role="tab" aria-controls="hor_1_tab_item-0" style="background: none; border-color: rgb(193, 193, 193);"><span class="resp-arrow"></span>Mã xác minh Google Master Tool</h2>
                            ...
                            <table cellspacing="1" class="admintable">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <textarea name="controls1$ctl00$ctl00$ctl00$txt_code" rows="2" cols="20" id="txt_code" class="inputbox" placeholder=" Trong phần xác minh google master tool chọn 'Các phương thức thay thế'. Sau đó chọn 'Thẻ HTML'. Sau đó copy mã code trong thẻ 'content' vào đây. Ví dụ: KBfwXD4fcJ4IbWmubM3q1nPWjxwdnTmXoO85AOkmGxk" style="height:100px;width:500px;"></textarea>
