...
class CategoryController extends BaseController
{
    ...
    public function submitCreateProduct(Request $request)
    {
        ...
        $data = [
            ...
            'distance_traveled_title' => !empty($request->distance_traveled_title) ? $request->distance_traveled_title : '',
            'maximum_speed' => !empty($request->maximum_speed) ? $request->maximum_speed : '',
            'maximum_speed_title' => !empty($request->maximum_speed_title) ? $request->maximum_speed_title : '',
            'allowable_weight_to_carry' => !empty($request->allowable_weight_to_carry) ? $request->allowable_weight_to_carry : '',
            'allowable_weight_to_carry_title' => !empty($request->allowable_weight_to_carry_title) ? $request->allowable_weight_to_carry_title : '',
            ...
            'heidi_title_banner6_top' => $request->heidi_title_banner6_top ?? '',
            'heidi_desc_banner6_top' => $request->heidi_desc_banner6_top ?? '',
            ...
            'nispa_images_banner1_mobile' => !empty($request->nispa_images_banner1_mobile) ? $this->uploadService->upload_param($request->nispa_images_banner1_mobile) : '',
        ...
        if (!empty($product)) {
            ...
            if (!empty($request->viva_gallery_mobile)) {
                $this->processImagesCreate($request->viva_gallery_mobile, $product->id, 'viva_gallery_mobile');
            }
    ...
    public function submitEditProduct($id, Request $request)
    {
        ...
        $data = [
            ...
            'nispa_images_banner1_mobile' => !empty($request->nispa_images_banner1_mobile) ? $this->uploadService->upload_param($request->nispa_images_banner1_mobile) : $this->productRepositories->find($id)->nispa_images_banner1_mobile,
        ...
        if (!empty($product)) {
            ...
            if (!empty($request->viva_gallery_mobile)) {
                $this->processImages($request->viva_gallery_mobile, $product->id, 'viva_gallery_mobile');
            }
