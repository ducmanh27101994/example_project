...
<main class="page-content">
    <section class="section-hero owl-carousel owl-theme">
        <div class="slider_item">
            <img src="
            @if(isset($table_config_images->banner_images))
                {{ $table_config_images->banner_images }}
            @endif
            "/>
        </div>
        <div class="slider_item">
            <img src="@if(isset($table_config_images->banner_images))
                {{ $table_config_images->banner_images }}
            @endif"/>
            <div class="hero-copy">
                <h2 class="hero-headline">Swap<span class="hero-headline__space"></span>&amp;<span
                        class="kv-headline__space"></span>Go</h2>
                    ...
                    <div class="parallax-bg">
                        <ul class="nav nav-pills cars-nav bikes-nav tab-buttons" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item " role="presentation">
                                    <span class="lowend-bike" id="lowend-tab" data-toggle="pill" role="tab"
                                          aria-controls="lowend" aria-selected="false">
                                    ...
                                    <div class="swiper-wrapper owl-carousel owl-theme">
                                        <div class="bike-item">
                                            <a href="#" class="bike-img">
                                                <img class src="{{ asset('home/images/item1.png') }}"
                                        ...
                                        <div class="bike-item">
                                            <a href="#" class="bike-img">
                                                <img class src="{{ asset('home/images/item2.png') }}"
                                                     alt="Xe máy điện Vento S"/>
                                            </a>
                                            <div class="bike-item-content">
                                        ...
                                        <div class="bike-item">
                                            <a href="#" class="bike-img">
                                                <img class src="{{ asset('home/images/item3.png') }}"
                                                     alt="Xe máy điện Theon"/>
                                            </a>
                                            <div class="bike-item-content">
                                        ...
                                        <div class="bike-item">
                                            <a href="#" class="bike-img">
                                                <img class src="{{ asset('home/images/item4.png') }}"
                                                     alt="Xe máy điện Theon S"/>
                                            </a>
                                            <div class="bike-item-content">
    ...
    <section class="section section-about">
        <div class="container">
            <div class="image-about-container" data-component-list="FadeInOut" data-interval="3000"
                 data-duration="1000">
        ...
        <div class="gallery-items">
            <div data-modal-trigger="gallery-modal" class="gallery-item">
                <figure class="image-gallery image-gallery--1"
                        style="background-image: url({{ asset('home/images/img_doc_left.png') }})"></figure>
            </div>
            <div data-modal-trigger="gallery-modal" class="gallery-item">
                <figure class="image-gallery image-gallery--2"
                        style="background-image: url({{ asset('home/images/img_ngang_top.png') }})"></figure>
            </div>
            <div data-modal-trigger="gallery-modal" class="gallery-item">
                <figure class="image-gallery image-gallery--3"
                        style="background-image: url({{ asset('home/images/img_ngang_bot_left.png') }})"></figure>
            </div>
            <div data-modal-trigger="gallery-modal" class="gallery-item">
                <figure class="image-gallery image-gallery--4"
                        style="background-image: url({{ asset('home/images/img_ngang_bot_right.png') }})"></figure>
            </div>
            <div data-modal-trigger="gallery-modal" class="gallery-item">
                <figure class="image-gallery image-gallery--5"
                        style="background-image: url({{ asset('home/images/img_doc_right.png') }})"></figure>
            </div>
        </div>
    </section>
        ...
        <div class="impact-slides">
            <div class="impact-slide impact-slide--co2">
                <div class="impact-copy">
                    ...
                    <p class="typography-impact-intro">The same amount of CO₂ as <span data-number="CO2"
                                                                                       data-transform="Math.floor($val / 10)"></span>
                        trees absorb every year.</p>
                </div>
            </div>
            ...
            <div class="impact-slide impact-slide--distance">
                <div class="impact-copy">
                    ...
                    <p class="typography-impact-intro">Equal to traveling around the Earth’s equator <span
                            data-number="KM" data-transform="Math.floor($val / 40000)"></span> times.</p>
                </div>
            </div>
        </div>
        ...
        <div class="ggr_wrapper_box_form">
            ...
            <div class="ggr_form">
                <div class="ggr_form_input">
                    <input type="text" class="form-control my-text-input" id="email" placeholder="Nhập email của bạn"
                           name="email"/>
