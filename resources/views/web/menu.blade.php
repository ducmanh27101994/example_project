            ...
            <div data-v-31312d37="" class="gc-container">
                <ul data-v-31312d37="" class="ggr-nav-list">
                    ...
                    <li data-v-31312d37="" class="ggr-nav-item ggr-nav-item--logo gc-desktop-visible"><a
                            data-v-0cc9144e="" data-v-31312d37="" href="/" class="nav-logo nav-logo--dark" style="background-image: url('<?= !empty($url) ? $url : '' ?>');">Gogoro</a>
                    </li>
                    @if(!empty($table_menu))
                        @foreach($table_menu as $value)
                        <li data-v-fae6e7a2="" data-v-31312d37="" class="ggr-nav-item"><a data-v-fae6e7a2="" href="{{$value->menu_router}}"
