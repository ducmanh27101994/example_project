            ...
            <section class="page-block top-main section active" id="pdp-top-main">
                <div class="box-block box-top-main">
                    <div class="top-main-wrap">
                        ...
                        <div class="top-main-btn js-aos" data-aos="fade-left" data-aos-delay="100"
                             data-aos-duration="300">
                            ...
                            <picture>
                                @if(!empty($feature_description))
                                    @foreach($feature_description as $value)
                                        <img
                                            data-src="{{$value->images}}"
                                            type="image/webp" alt="Xe máy điện VinFast Evo200 thiết kế sang trọng"
                                            width="100%"
                                            class="img-lazy"/>
                                    @endforeach
                                @endif
                                ...
                                <div class="parts-bike__item js-aos container" data-aos="fade-left" data-aos-delay="0"
                                    ...
                                    <picture class="image-story">
                                        <source class="img-srcset"
                                                data-srcset="{{ $value->images }}"
                                                type="image/webp"/>
                                        <img data-src="{{ $value->images }}" title="Evo200"
                                             alt="Hệ thống đèn LED và đèn pha projector của xe máy điện VinFast Evo200"
                    ...
                    <div class="parts-bike__list parts-bike__list__gallarey">
                        @if(!empty($actual_photo))
                            @foreach($actual_photo as $value)
                                <div class="parts-bike__item js-aos aos-init aos-animate" data-aos="fade-left"
                                     data-aos-delay="0" data-aos-duration="300">
                                    <picture>
                                        <source class="img-srcset"
                                                data-srcset="{{$value->images}}"
                                                type="image/webp"
                ...
                <div class="battery-technology__container">
                    <div class="battery-technology__item js-aos" data-aos="fade-left" data-aos-delay="0"
                        ...
                        @if(!empty($product->representative_image))
                            <img
                                data-src="{{$product->representative_image}}"
                ...
                <div class="breaking-wrap">
                        ...
                        <div class="breaking-top__img breaking-slick">
                            <div class="slick-slide">
                                ...
                                @if(!empty($product->representative_image))
                                    <picture>
                                        <source class="img-srcset"
                                                data-srcset="{{$product->representative_image}}"
                                                type="image/webp"/>
                                        <img class="img-lazy"
                                             data-src="{{$product->representative_image}}"
                    ...
                    <div class="breaking-technology-bot">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="tabInfoProduct" data-toggle="tab"
                                   href="javascript:void(0)" role="tab" aria-controls="home" aria-selected="true">
