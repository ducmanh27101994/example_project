...
@section('content')
    <form method="post" action="{{route('admin.submit.editBannerAds', ['id' => $banner->id])}}" enctype="multipart/form-data">
        @csrf
        <div id="page-wrapper">
                                                ...
                                                <span class="detail_error">
                                                    ...
                                                    <table cellspacing="1" class="admintable">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input name="title"
                                                                       type="text" id="txtname" class="inputbox error"
                                                                       minlength="2" required="" aria-required="true"
                                                                       aria-invalid="true" style="width:364px;"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                @if($errors->has('code_ads'))
                                                                    <p class="text-danger"
                                                                       style="margin-top: 10px;">{{ $errors->first('code_ads') }}</p>
                                                                @endif
                                                            </td>
                                                        </tr>
                                                        <tr>
