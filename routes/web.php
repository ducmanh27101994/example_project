...
//    Route::get('/near-by-store', 'App\Http\Controllers\TemplateController@nearbyStore');
    ...
    Route::get('/template/order', 'App\Http\Controllers\TemplateController@order');
...
Route::get('/san-pham', 'App\Http\Controllers\HomePageController@categoryProduct')->name('category.product');
