                        ...
                        <div class="container">
                            <div class="parallax-bg">
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <div class="midend-bike" id="midend-bike" role="tabpanel"
                                         aria-labelledby="midend-bike-tab">
                                        <div class="swiper-bike escooter-swiper">
                                            <div class="swiper-wrapper owl-carousel owl-theme">
                                                <div class="bike-item">
                                                    <a href="#" class="bike-img">
                                    ...
                                    <div class="lowend-bike" id="lowend-bike" role="tabpanel"
                ...
                <form action="{{route('admin.contact.submit')}}" method="post">
                    ...
                    <div class="ggr_form">
                        <div class="ggr_form_input">
                            <input type="email" class="form-control my-text-input" id="email"
