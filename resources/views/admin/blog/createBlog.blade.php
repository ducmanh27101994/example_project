                                        ...
                                        <div class="col-sm-8">
                                            <div class="block_sp">
                                                <div class="form-group">
                                                    ...
                                                    <input name="news_headlines" type="text" id="txtnewsname"
                                                        class="inputbox" placeholder="Nhập tiêu đề tin"
                                                        style="width:100%;" value="{{old('news_headlines')}}">
                                                    @if($errors->has('news_headlines'))
                                                        <p class="text-danger" style="margin-top: 10px;">
                                                            {{ $errors->first('news_headlines') }}
                                                        </p>
                                                    @endif
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <input name="news_products_links" type="text" id="txtnewsname"
                                                        class="inputbox" placeholder="Nhập link sản phẩm"
                                                        style="width:100%;" value="">
                                                </div>

                                                <div class="form-group">
                                                    <label class="next-label">Mô tả</label>
                                                    <textarea name="describe" rows="2" cols="20" id="describe"
                                                        class="inputbox "
                                            ...
                                            <div class="block_sp hidden">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="bootstrap-tagsinput">
                                                        ...
                                                        <input name="controls1$ctl00$ctl00$ctl00$txt_tag" type="text"
                                        ...
                                        <div class="col-sm-4">
                                            <div class="block_sp">
                                                <div class="form-group">
                                                    <label class="text-no-bold" data-bind="text:Title"
                                                        style="font-weight:bold">Hình ảnh đại diện (908 x 406
                                                        pixel)</label>
                                            ...
                                            <div class="block_sp">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="category_id" id="ddlcate" class="inputbox"
                                                        style="width:100%;">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @if(!empty($listProduct))
                                                        @foreach($listProduct as $value)
                                                            <input id="chknews" type="checkbox" name="recommended_products[]"
                                                                checked="checked"
                                                                value="{{$value->id}}">{{$value->product_name}}<br>
                                                        @endforeach
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="block_sp">
                                                <div class="form-group">
                                                    ...
                                                    <input id="chknewshot" type="checkbox" name="chknewshot"> Tin
                                                    mới<br>
                                                </div>
                                            </div>
                                            <div class="block_sp">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#" class="tooltip">
                                                        ...
                                                        <span><b>Tiêu đề trang</b><br>
                                                            Nội dung được hiển thị dưới dạng tiêu đề trong kết quả tìm
                                                            kiếm và trên trình duyệt của người dùng. <br><i>(Tiêu đề nên
                                                                để dưới 70 ký tự)</i>
                                                        </span>
                                                    </a>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="next-input--stylized">
                                                        ...
                                                        <input name="path" type="text" id="txturl" class="txtpa"
                                                            style="width:335px;" value="{{old('path')}}" readonly>
                                                    </div>
                                                    <a href="#" class="tooltip">
                                                        <img src="{{ asset('images/help-icon.png') }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <textarea name="description_card" rows="5" cols="70"
                                                        id="txtmetadesc" class="inputbox"
                                                        style="height:80px;">{{old('description_card')}}</textarea>
                                                    <a href="#" class="tooltip">
                                                        <img src="{{ asset('images/help-icon.png') }}">
                                                        <span><b>Thẻ mô tả</b><br>
                                                            Cung cấp một mô tả ngắn của trang. Trong vài trường hợp, mô
                                                            tả này được sử dụng như một phần của đoạn trích được hiển
                                                            thị trong kết quả tìm kiếm. <br><i>(Mô tả nên để dưới 160 ký
                                                                tự)</i>
                                                        </span>
                                                    </a>
                                                </td>
