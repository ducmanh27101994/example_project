                ...
                <div class="mySliderTop">
                    @if(!empty($icon_images) && !empty($color_image))
                        @for($i=0; $i < count($icon_images) ; $i++)
                            <div class>
                                <picture>
                                    <source srcset="{{ $color_image[$i] }}"
                                            type="image/webp"/>
                                    <img data-lazy="{{ $color_image[$i] }}" title
            ...
            <div class="section-content">
                ...
                <div class="design-topics">
                    <div class="design-topic">
                        <div class="design-topic__image aos-init aos-animate" data-aos="fade-up"
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="dong-co-xanh_img ">
                            <div class="wrap_image aos-init aos-animate" data-aos="zoom-out-down"
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="menu_item_fixed_policy">
                            <p><a href="#" title="ĐIỀU KHOẢN PHÁP LÝ"><img
                                            src="{{ asset('home/images/akar-icons_question.png') }}"
                                            alt="akar-icons_question">
