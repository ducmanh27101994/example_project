...
@section('content')
    ...
    function showlistCategery($menuChils, $parent_id = 0, $char = '')
    {
        ...
        foreach ($menuChils as $key => $item) {
                ...
                echo ' <td align="center"><a href="https://vntravelsimple.com/chuyen-muc-tin-81" target="_blank" title="Xem chi tiết"><img src="https://vntravelsimple.com/templates/admin/images/view.png"></a>&nbsp; &nbsp;<a id="LinkButton3" title="Sửa" href="' . route('admin.edit.cate.product', $item->id) . '"><img src="https://vntravelsimple.com/templates/admin/images/iconedit_c.png"></a> &nbsp; &nbsp;</td>';
                echo '</tr>';
                echo '</tbody>';
        }
    }
