                                        ...
                                        <div class="col-sm-8">
                                            <div class="block_sp">
                                                <div class="form-group">
                                                    ...
                                                    <input name="news_headlines" type="text" id="txtnewsname" class="inputbox" placeholder="Nhập tiêu đề tin" style="width:100%;" value="{{old('news_headlines')}}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="describe" rows="2" cols="20" id="describe" class="inputbox " style="height:80px;width:100%;">{{old('describe')}}</textarea>

                                                </div>
                                                <div class="form-group">
                                                    <label class="next-label">Chi tiết</label>
                                                    <textarea name="detail" id="detail" cols="50" rows="30">{{old('detail')}}</textarea>
