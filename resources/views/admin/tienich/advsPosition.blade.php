...
@section('content')
<form method="post" action="{{route('admin.submit.createBannerAds')}}" enctype="multipart/form-data">
    @csrf
    <div id="page-wrapper">
                                            ...
                                            <div class="resp-tab-content hor_1 resp-tab-content-active"
                                                ...
                                                <table cellspacing="1" class="admintable">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input name="title" type="text" id="txtname"
                                                                    ...
                                                                    style="width:364px;" value="{{old('title')}}">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input name="txt_link" type="text" id="txt_link"
                                                                    class="inputbox" style="width:350px;" value="">
                                                                <a href="#" class="tooltip">
                                                                    <img src="{{ asset('images/help-icon.png') }}">
                                                        ...
                                                        <tr>
                                                            <td class="key">
                                                                <label for="txtphone">Ảnh banner mobile dành cho slide trang chủ</label>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input id="chkstatus" type="checkbox"
                                                                    name="status"><label for="chkstatus"> Hiển
                                                                    thị</label>
