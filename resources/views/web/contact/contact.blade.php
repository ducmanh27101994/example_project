                        ...
                        <form method="post" action="{{route('submit.contact.form')}}">
                            ...
                            <div class="group_input">
                                ...
                                <div class="form_ipnput">
                                    <input type="text" required class="form-control input-authen" name="full_name"
                                        id="name" placeholder="Họ tên" />
                                </div>
                                <div class="form_ipnput">
                                    <input type="number" required class="form-control input-authen" name="phone"
                                        id="phone" placeholder="Số điện thoại" />
                                </div>
                                <div class="form_ipnput">
                                    <input type="email" required class="form-control input-authen" name="email"
                                        id="email" placeholder="Email" />
                                </div>
                                <div class="form_ipnput">
                                    <input type="text" required class="form-control input-authen" name="address"
                                        id="address" placeholder="Địa chỉ" />
                                </div>
                                <div class="form_ipnput dtmb_block" style="display: none">
                                    <input type="number" class="form-control input-authen" name="acreage"
                                        id="acreage" placeholder="Diện tích mặt bằng" />
                                    <span>
                                        m<sup>2</sup>
                                    </span>
                                </div>
                                <div class="form_ipnput">
                                    <textarea style="height: unset;" name="contents" id="content" require
                                        class="form-control input-authen" placeholder="Nội dung" rows="4"
                                        cols="50"></textarea>
                                </div>
