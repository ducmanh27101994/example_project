    ...
    function showlistCategery($menuChils, $parent_id = 0, $char = '')
    {
        ...
        foreach ($menuChils as $key => $item){
            if ($item->parent_id == $parent_id) {
                ...
                echo ' <td align="center"><a href="https://vntravelsimple.com/chuyen-muc-tin-81" target="_blank" title="Xem chi tiết"><img src="https://vntravelsimple.com/templates/admin/images/view.png"></a>&nbsp; &nbsp;<a id="LinkButton3" title="Sửa" href="'. route('admin.editCate', $item->id) .'"><img src="'.asset('/images/iconedit_c.png').'"></a> &nbsp; &nbsp;</td>';
                echo '</tr>';
                echo '</tbody>';
