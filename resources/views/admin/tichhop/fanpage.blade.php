...
@section('content')
    <form method="post" action="{{route('admin.submit.indexFanpage')}}">
        @csrf
        <div id="page-wrapper">
                            ...
                            <div class="resp-tabs-container hor_1" style="border-color: rgb(193, 193, 193);">
                                <h2 class="resp-accordion hor_1 resp-tab-active" role="tab"
                                    ...
                                    style="background: none; border-color: rgb(193, 193, 193);"><span
                                        class="resp-arrow"></span>Mã page facebook</h2>
                                    ...
                                    <table cellspacing="1" class="admintable">
                                        ...
                                        <tr>
                                            ...
                                            <textarea name="embed_code" rows="2" cols="20"
                                                      id="txt_code" class="inputbox" style="height:100px;width:500px;">{{!empty(old('embed_code')) ? old('embed_code') : $config->embed_code}}</textarea>
