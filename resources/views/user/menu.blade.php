        ...
        <div data-v-31312d37="" class="ggr-header-container">
            <div data-v-31312d37="" class="gc-container">
                <ul data-v-31312d37="" class="ggr-header">
                    <li data-v-31312d37="" class="ggr-header-item menuicon-item">
                        <label data-v-67f16422="" data-v-31312d37="" for="nav-menustate" class="nav-menuicon"><span
                                data-v-67f16422="" class="nav-menuicon-bread nav-menuicon-bread--top"><span
                                    data-v-67f16422="" class="nav-menuicon-crust nav-menuicon-crust--top"></span></span><span
                    ...
                    <li data-v-31312d37="" class="ggr-header-item logo-item"><a data-v-0cc9144e="" data-v-31312d37=""
                                                                                href="/"
                                                                                class="nav-logo nav-logo--dark">Gogoro</a>
                    </li>
                    <li data-v-31312d37="" class="ggr-header-item my-gogoro-item"><a data-v-893155ac=""
                                                                                     data-v-31312d37=""
                                                                                     href="//my.gogoro.com?lang=en-US"
            ...
            <div data-v-31312d37="" class="gc-container">
                <ul data-v-31312d37="" class="ggr-nav-list">
                    <li data-v-31312d37="" class="ggr-nav-item ggr-nav-item--logo gc-desktop-visible"><a
                            ...
                            style="background-image: url('@if(isset($table_config_images->image_icon_right)) {{ $table_config_images->image_icon_right }} @endif');">Gogoro</a>
                    </li>
                    {{--Menu--}}
                    @if(!empty($table_menu))
                        @foreach($table_menu as $value)
                            <li data-v-fae6e7a2="" data-v-31312d37="" class="ggr-nav-item"><a data-v-fae6e7a2=""
                                                                                              href="{{$value->menu_router}}"
                                                                                              class="ggr-nav-link nav-list__link--dark"><span
                    ...
                    <li data-v-fae6e7a2="" data-v-31312d37="" class="ggr-nav-item ggr-nav-item--secondary"><a
                            data-v-fae6e7a2="" href="https://investor.gogoro.com/"
                            class="ggr-nav-link nav-list__link--dark btn btn-button btn-style-acc"><span
                                data-v-fae6e7a2="">Tài Khoản</span><!----></a>
                    </li>
                    <li data-v-fae6e7a2="" data-v-31312d37="" class="ggr-nav-item ggr-nav-item--secondary"><a
                            data-v-fae6e7a2="" href="/media-center/" class="ggr-nav-link nav-list__link--dark"><span
                                data-v-fae6e7a2="">VN</span><!----></a>
                    </li>
                    <!---->
                </ul>
            </div>
