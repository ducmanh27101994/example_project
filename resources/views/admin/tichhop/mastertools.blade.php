...
@section('content')
    <form method="post" action="{{route('admin.submit.indexMastertools')}}">
        @csrf
        <div id="page-wrapper">
                ...
                <div class="widget-title">
                    ...
                    <div class="widget-title">
                        <h4><i class="icon-reorder">
                                Tích hợp mã Google Master Tool</i></h4>
                        ...
                        <div style="width: 100%; display: block; margin: 0px;" id="parentHorizontalTab"
                            ...
                            <ul class="resp-tabs-list hor_1">
                                <li class="resp-tab-item hor_1 resp-tab-active" aria-controls="hor_1_tab_item-0"
                                    role="tab" style="background-color: white; border-color: rgb(193, 193, 193);">Mã xác
                                    minh Google Master Tool
                                </li>
                            ...
                            <div class="resp-tabs-container hor_1" style="border-color: rgb(193, 193, 193);">
                                <h2 class="resp-accordion hor_1 resp-tab-active" role="tab"
                                    ...
                                    style="background: none; border-color: rgb(193, 193, 193);"><span
                                        class="resp-arrow"></span>Mã xác minh Google Master Tool</h2>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <textarea name="embed_code" rows="2" cols="20"
                                                          ...
                                                          placeholder=" Trong phần xác minh google master tool chọn 'Các phương thức thay thế'. Sau đó chọn 'Thẻ HTML'. Sau đó copy mã code trong thẻ 'content' vào đây. Ví dụ: KBfwXD4fcJ4IbWmubM3q1nPWjxwdnTmXoO85AOkmGxk"
                                                ...
                                                <a href="#" class="tooltip">
                                                    ...
                                                    <br>
                                                    Ví dụ: <textarea rows="8" cols="40" onclick="this.select();"
                                                                     readonly="" class="token">&lt;meta name="google-site-verification" content="KBfwXD4fcJ4IbWmubM3q1nPWjxwdnTmXoO85AOkmGxk" /&gt;</textarea> thì chỉ copy nội dung "KBfwXD4fcJ4IbWmubM3q1nPWjxwdnTmXoO85AOkmGxk"
                                                </span>
                                                </a>
                                            </td>
