	...
	...</li>
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="block_sp">
                                                ...
                                                <div class="form-group">
                                                    <label class="next-label">Loại giao diện Loại giao diện (tabs thêm nội dung giao diện tương ứng của ladipage xuất hiện bên cạnh cầu hình seo khi chọn giao diện)</label>
