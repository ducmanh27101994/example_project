...
@section('content')
    ...
    <form action="{{route('admin.submit.editMenu', ['id' => $editMenu->id])}}" method="post">
        @csrf
        <div id="page-wrapper">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select name="parent_id"
                                                                    ...
                                                                    <?php showMenus($menu, $editMenu->parent_id) ?>
                                                                </select>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input name="menu_title"
                                                                       ...
                                                                       style="width:450px;"
                                                                       value="{{!empty(old('menu_title')) ? old('menu_title') : $editMenu->menu_title}}">
                                                                <a href="#" class="tooltip">
                                                                    <img src="{{ asset('images/help-icon.png') }}">
                                                                    <span><b>Tiêu đề</b><br>
                                                                ...
                                                                <ul>
                                                                    <li><span style="display: none; width: 140px;">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            style="width:450px;"
                                                                            value="{{!empty(old('menu_router')) ? old('menu_router') : $editMenu->menu_router}}">
                                                                        <a href="#" class="tooltip">
                                                                            <img
    ...
    function showMenus($menuChils, $edit_parent_id, $parent_id = 0, $char = '')
    {
        ...
        foreach ($menuChils as $key => $item){
            if ($item->parent_id == $parent_id) {
                ...
                echo '<option '.$selected.'  value="'.$item->id.'">'. $char .$item->menu_title.'</option>';
                showMenus($menuChils, $edit_parent_id, $item->id, $char. '--');
            }
        }
    }
