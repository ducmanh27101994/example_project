...
@section('content')
    <form method="post" action="{{route('admin.submit.editAccount',["id" => $user->id])}}">
        @csrf
        <div id="page-wrapper">
                                                ...
                                                <div class="resp-tab-content hor_1 resp-tab-content-active"
                                                    ...
                                                    <table cellspacing="1" class="admintable">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input readonly name="password"
                                                                       type="password" id="txtpass" class="inputbox"
                                                                       style="width:250px;"
                                                                       value="{{!empty(old('password')) ? old('password') : $user->password}}">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input readonly name="password_confirmation"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input name="full_name"
                                                                       ...
                                                                       style="width:250px;"
                                                                       value="{{!empty(old('full_name')) ? old('full_name') : $user->full_name}}">
                                                                <a href="#" class="tooltip">
                                                                    <img src="{{ asset('images/help-icon.png') }}">
