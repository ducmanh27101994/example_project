...
@section('content')
    <form method="post" action="{{route('admin.submit.editCate', ['id' => $editCate->id])}}">
        @csrf
        <div id="page-wrapper">
                                                ...
                                                <div class="resp-tab-content hor_1 resp-tab-content-active"
                                                    ...
                                                    <table cellspacing="1" class="admintable">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input
                                                                    value="{{!empty(old('category_title')) ? old('category_title') : $editCate->category_title}}"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select name="parent_id"
                                                                    ...
                                                                    <?php showCategoryEdit($category, $editCate->parent_id) ?>
                                                ...
                                                <div class="resp-tab-content hor_1" aria-labelledby="hor_1_tab_item-3"
                                                    ...
                                                    <table class="admintable">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div>
                                                                    <span class="page-title-seo">{{$editCate->page_title_tag}}</span>
                                                                    <div class="page-description-seo ws-nm">
                                                                        <span>{{ url()->to('/') . '/' }}{{$editCate->path}}</span></div>
                                                                    <div class="page-url-seo ws-nm">
                                                                         {{$editCate->description_card}}
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input name="page_title_tag" type="text"
                                                                       ...
                                                                       style="width:460px;"
                                                                       value="{{!empty(old('page_title_tag')) ? old('page_title_tag') : $editCate->page_title_tag}}">
                                                                <a href="#" class="tooltip">
                                                                    <img src="{{ asset('images/help-icon.png') }}">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="next-input--stylized">
                                                                    ...
                                                                    <input
                                                                        value="{{!empty(old('path')) ? old('path') : $editCate->path}}"
                                                                        name="path"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <textarea name="keyword_tags" rows="5" cols="70"
                                                                          ...
                                                                          style="height:80px;">{{!empty(old('keyword_tags')) ? old('keyword_tags') : $editCate->keyword_tags}}</textarea>
                                                                <a href="#" class="tooltip">
                                                                    <img src="{{ asset('images/help-icon.png') }}">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <textarea name="description_card" rows="5" cols="70"
                                                                          ...
                                                                          style="height:80px;">{{!empty(old('description_card')) ? old('description_card') : $editCate->description_card}}</textarea>
                                                                <a href="#" class="tooltip">
                                                                    <img src="{{ asset('images/help-icon.png') }}">
    ...
    function showCategoryEdit($menuChils, $edit_parent_id, $parent_id = 0, $char = '')
    {
        ...
        foreach ($menuChils as $key => $item) {
            if ($item->parent_id == $parent_id) {
                ...
                showCategoryEdit($menuChils, $edit_parent_id, $item->id, $char . '--');
            }
        }
    }
