                ...
                <div class="grid">
                    ...
                    <div class="grid-item grid-item--tile grid-item--experience-flodrive span-12 span-md-6"
                        ...
                        <div class="image-flodrive-loop" data-component-list="FadeInOut">
                            <figure class="image-flodrive-loop image-flodrive-loop--solid" style="background-image: url({!! $value->avatar !!}"></figure>
                            <figure class="image-flodrive-loop image-flodrive-loop--transparent" style="background-image: url({!! $value->avatar !!})"></figure>
                        </div>
