                                        ...
                                        <div class="col-sm-8">
                                            <div class="block_sp">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="desc" id="txtdesc" class="inputbox " style="width:100%;" value="{{!empty(old('desc')) ? old('desc') : $store->desc}}" />
                                                </div>
                                                <div class="form-group">
                                                    <label class="next-label">Link google map</label>
                                                    <input name="maplink" id="txtmaplink" class="inputbox " style="width:100%;" value="" />
                                                </div>
                                                <div class="block_sp">
                                                    <div class="form-group">
