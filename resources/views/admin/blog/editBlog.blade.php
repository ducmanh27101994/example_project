...
@section('content')
<form method="post" action="{{route('admin.submit.editBlog',['id' => $editBlog->id])}}" enctype='multipart/form-data'>
    @csrf
    <div id="page-wrapper">
                        ...
                        <table class="toolbar">
                            <tbody>
                                <tr>
                                    ...
                                    <td align="center">
                                        <a id="lnkclose" class="toolbar" href="{{route('admin.indexListBlog')}}">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <div class="block_sp">
                                                <div class="form-group">
                                                    ...
                                                    <input name="news_headlines" type="text" id="txtnewsname" class="inputbox" placeholder="Nhập tiêu đề tin" style="width:100%;" value="{{!empty(old('news_headlines')) ? old('news_headlines') : $editBlog->news_headlines}}">
                                                    @if($errors->has('news_headlines'))
                                                    <p class="text-danger" style="margin-top: 10px;">{{ $errors->first('news_headlines') }}</p>
                                                    @endif
                                                </div>
                                                <div class="form-group">
                                                    <label class="next-label">Mô tả</label>
                                                    <textarea name="describe" rows="2" cols="20" id="describe" class="inputbox " style="height:80px;width:100%;">{{!empty(old('news_headlines')) ? old('news_headlines') : $editBlog->describe}}</textarea>

                                                </div>
                                                <div class="form-group">
                                                    <label class="next-label">Chi tiết</label>
                                                    <textarea name="detail" id="detail" cols="50" rows="30">{{!empty(old('news_headlines')) ? old('news_headlines') : $editBlog->detail}}</textarea>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="block_sp">
                                                ...
                                                <div class="center">
                                                    <img height="100" style="max-width:600px" @if(!empty($editBlog->representative_image))
                                                    src="{{$editBlog->representative_image}}"
                                                    @endif
                                                    >
                                            ...
                                            <div class="block_sp">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="category_id" id="ddlcate" class="inputbox" style="width:100%;">
                                                        <?php showCategory($category, $editBlog->category_id); ?>
                                            ...
                                            <div class="block_sp">
                                                <div class="form-group">
                                                    ...
                                                    <input id="chkstatus" type="checkbox" name="status" @if($editBlog->status == 'active')
                                                    checked="checked"
                                                    @endif
                                                    > Hiển thị<br>
                                                </div>
                                    ...
                                    <table class="admintable">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                        <span class="page-title-seo">{{$editBlog->page_title_tag}}</span>
                                                        <div class="page-description-seo ws-nm">
                                                            <span>{{ url()->to('/') . '/' }}{{$editBlog->path}}</span>
                                                        </div>
                                                        <div class="page-url-seo ws-nm">
                                                            {{$editBlog->description_card}}
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <input name="page_title_tag" type="text" id="txttitleweb" class="inputbox" style="width:460px;" value="{{!empty(old('page_title_tag')) ? old('page_title_tag') : $editBlog->page_title_tag}}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="next-input--stylized">
                                                        <span class="next-input-add-on next-input__add-on--before">{{ url()->to('/') . '/detail-blog/' }}</span>

                                                        <input value="{{!empty(old('slug')) ? old('slug') : $editBlog->slug}}" name="slug" type="text" id="txturl" class="txtpa" style="width:335px;">
                                                    </div>
                                                    <a href="#" class="tooltip">
                                                        <img src="{{ asset('images/help-icon.png') }}">
                                                    ...
                                                    @if($errors->has('slug'))
                                                    <p class="text-danger" style="margin-top: 10px;">{{ $errors->first('slug') }}</p>
                                                    @endif
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <textarea name="keyword_tags" rows="5" cols="70" id="txtkeyword" class="inputbox" style="height:80px;">{{!empty(old('keyword_tags')) ? old('keyword_tags') : $editBlog->keyword_tags}}</textarea>
                                                    <a href="#" class="tooltip">
                                                        <img src="{{ asset('images/help-icon.png') }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <textarea name="description_card" rows="5" cols="70" id="txtdesc" class="inputbox" style="height:80px;">{{!empty(old('description_card')) ? old('description_card') : $editBlog->description_card}}</textarea>
                                                    <a href="#" class="tooltip">
                                                        <img src="{{ asset('images/help-icon.png') }}">
...
function showCategory($category, $edit_parent_id, $parent_id = 0, $char = '')
{
    foreach ($category as $key => $item) {
        if ($item->parent_id == $parent_id) {
            ...
            if ($edit_parent_id == $item->id) {
                $selected = 'selected';
            } else {
                $selected = '';
            }

            echo '<option ' . $selected . ' value="' . $item->id . '">' . $char . $item->category_title . '</option>';
            showCategory($category, $edit_parent_id, $item->id, $char . '--- ');
        }
    }
}
