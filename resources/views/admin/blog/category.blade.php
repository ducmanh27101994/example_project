    ...
    <div id="page-wrapper">
        ...
        <div class="widget">
            ...
            <div class="widget-title">
                ...
                <div class="widget-title">
                    <h4><i class="icon-reorder">Danh mục tin tức</i></h4>
                        ...
                        <div id="toolbox">
                            ...
                            <div style="float:right;margin-right: 10px;" class="toolbox-content">
                                ...
                                <table class="toolbar">
                                    ...
                                    <tr>
                                        <td align="center">
                                            <a id="lnkadd" class="toolbar" href="{{route('admin.indexCreateCategory')}}">
    ...
    function showlistCategery($menuChils, $parent_id = 0, $char = '')
    {
        ...
        foreach ($menuChils as $key => $item){
            if ($item->parent_id == $parent_id) {
                echo '<tbody>';
                echo '<tr class="row0">';
                echo '<td><a>'. $char .$item->category_title .'</a></td>';
                ...
                echo ' <td align="center"><a href="https://vntravelsimple.com/chuyen-muc-tin-81" target="_blank" title="Xem chi tiết"><img src="https://vntravelsimple.com/templates/admin/images/view.png"></a>&nbsp; &nbsp;<a id="LinkButton3" title="Sửa" href="'. route('admin.editCate', $item->id) .'"><img src="https://vntravelsimple.com/templates/admin/images/iconedit_c.png"></a> &nbsp; &nbsp;</td>';
                echo '</tr>';
                echo '</tbody>';
                showlistCategery($menuChils, $item->id, $char. '--- ');
            }
        }
    }
