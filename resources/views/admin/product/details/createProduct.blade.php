...
<h3>Smartkey</h3>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="block_sp">
                                            <div class="form-group">
                                                <label class="text-no-bold" data-bind="text: Title">Hình ảnh banner xe (section 1) kt: 550x854</label>
                                                <input type="file" name="nispa_images_banner1_mobile" class="pull-right" style="width:180px;">
                                            </div>
                                        </div>
                                    </div>
